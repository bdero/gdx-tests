...
public class Drop implements ApplicationListener {
	...
	public void render() {
		...
		batch.begin();
			...
			font.draw(batch, "Droplets collected: " + dropsCollected, 10, camera.viewportHeight - 10);
